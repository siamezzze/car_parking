...
const QMetaObjectExtraData QPaintWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QPaintWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QPaintWidget,
      qt_meta_data_QPaintWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QPaintWidget::getStaticMetaObject() { return staticMetaObject; }
